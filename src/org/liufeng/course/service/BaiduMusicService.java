...
public class BaiduMusicService {
	...
	public static Music searchMusic(String musicTitle, String musicAuthor) {
		// 百度音乐搜索https://c.y.qq.com/soso/fcgi-bin/client_search_cp?aggr=1&cr=1&flag_qc=0&p=1&n=30&w=简单爱
		String requestUrl = "https://c.y.qq.com/soso/fcgi-bin/client_search_cp?aggr=1&cr=1&flag_qc=0&p=1&n=30&w=简单爱";
		// 对音乐名称、作者进URL编码
	...
	private static Music parseMusic(String url) {
		String dst = HttpRequestUtil.httpRequest(url);
		String data = dst.substring("callback(".length(), dst.length()-1);
		System.out.println(data);
		JSONArray array = JSONObject.fromObject(data).getJSONObject("data").getJSONObject("song").getJSONArray("list");
		System.out.println(array);
		String songid = array.getJSONObject(0).getString("songid");
...
//		}
	...
	public static void main(String[] args) {
		Music music = searchMusic("今天", "刘德华");
